...
format CONDENSÉ observé dans human et toy_example5 : ("5000 <A> G1 from
1", ou "70 <A> 10 <X> 10 <M> 10 <Y> G1 from 1"), pas au format détaillé
...
def _extract_loci_info(text: str) -> tuple[dict[str, int], str, str]:
...
def parse_loci_description(header_text: str) -> LociDescription:
    ...
    total_loci, group, start_1based = _extract_loci_info(content_line)
