...
from bridge.summary_statistics import (
    compute_ML1, compute_ML2, compute_ML3, compute_HW_HB,
    compute_FST1, compute_FST2, compute_NEI, compute_AML,
    compute_F3_F4, compute_FST3_FST4_FSTG,
)
...
pop_names = list(build_samples_argument("reference/human/human_snp_all22chr_maf5.snp").keys())

funcs = {
    "ML1": compute_ML1, "ML2": compute_ML2, "ML3": compute_ML3,
    "HW_HB": compute_HW_HB, "FST1": compute_FST1, "FST2": compute_FST2,
    "NEI": compute_NEI, "AML": compute_AML, "F3_F4": compute_F3_F4,
